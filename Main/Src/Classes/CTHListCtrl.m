...
//        
//        _initialItemIndex = nil; // do not autoselect by default
//        
...
//        weakSelfMacro;
//        
//        [_items setOnDidChangeSelection:^(ExtMutableArray *array, id targetObject, EMAChangeType changeType) {
//            
//            [weakSelf selectCurrentCell];
//            
//            //===
//            
//            if (weakSelf.primaryObserver)
//            {
//                [weakSelf.primaryObserver applyItem:array.selectedObject];
//            }
//        }];
//    }
//    return self;
...
//{
//    NSMutableSet *indexesToDeselect =
//    [NSMutableSet setWithArray:self.tableView.indexPathsForSelectedRows];
//    
//    NSSet *selectedIndexes = [];
//    
//    //===
//    
//    if (self.items.selection.count)
//    {
//        [self.tableView
